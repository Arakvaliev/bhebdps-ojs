describe("About Control Structures (about_control_structures.js)", function(){
  ...
  it("ternary operator", function() {
    ...
    expect('apple', 'what is the value of fruit?').toBe(fruit, 'what is the value of fruit?');

    fruit = false ? "apple" : "orange";
    expect('orange', 'now what is the value of fruit?').toBe(fruit, 'now what is the value of fruit?');
  });
